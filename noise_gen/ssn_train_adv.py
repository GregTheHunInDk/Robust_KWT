...
def main(args):
    ...
    noise_path = [
        "/home/ubuntu/noise/ssn/ssn_train.wav", 
        "/home/ubuntu/noise/cln/cln_train.wav"
    ]
    noise_names = ['ssn', 'cln']
    snr = args.snr
    ...
    noise_name = "ssn" #noise_path.split('/')[-1][0:-4] # takes the last part of the path (file name) and removes the .wav extention
