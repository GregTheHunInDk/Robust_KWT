...
def main(args):
    ...
    snr = args.snr
    save_path = '/home/ubuntu/noisy_speech_commands_v0.02/seeded/'
    data_list = data_path + "_generated/sorted/training_list.txt"
    print(data_list)
    data_list = "/home/ubuntu/speech_commands_v0.02/_generated/sorted/training_list.txt"
    ...
    noisy_data_list = open(save_path + noisy_path + "training_list.txt", "w")
